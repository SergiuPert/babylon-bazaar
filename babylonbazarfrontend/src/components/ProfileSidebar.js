...
const ProfileSidebar = (props) => {
    ...
    return (
        <div>
            ...
            <ProfileButton buttonStyle="CategoriesHeaderButton" buttonTextStyle="CategoriesHeaderButtonText" link={props.setCurrentPage} text="Funds" />
            <ProfileButton buttonStyle="CategoriesHeaderButton" buttonTextStyle="CategoriesHeaderButtonText" link={props.setCurrentPage} text="OrderHistory" />
